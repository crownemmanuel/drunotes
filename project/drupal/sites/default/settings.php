 ...
 * @endcode
 */
$settings['hash_salt'] = 'ZGVmYXVsdAAAAAFhAAANAFAPjn4UAAAAAQABAA==';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drunotes_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drunotes_dd.inc';
}
// </DDSETTINGS>
